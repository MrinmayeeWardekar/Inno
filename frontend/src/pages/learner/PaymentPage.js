        ...
        <div style={{ background: 'rgba(14,11,26,0.8)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 28, padding: 36, backdropFilter: 'blur(20px)' }}>
          ...
          <div style={{ marginTop: 20, padding: '20px', background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 16, textAlign: 'center' }}>
            ...
            <div style={{ background: 'white', borderRadius: 12, padding: 12, display: 'inline-block', marginBottom: 10 }}>
              <img src={`https://api.qrserver.com/v1/create-qr-code/?size=140x140&data=upi://pay?pa=mrinnn06@oksbi&pn=InnoVenture&am=${course?.price || 0}&cu=INR&tn=${encodeURIComponent('Course Payment - ' + (course?.title || ''))}`} alt="UPI QR Code" style={{ width: 140, height: 140, display: 'block' }} />
            </div>
            <div style={{ fontSize: 12, color: 'rgba(255,255,255,0.4)', marginBottom: 4 }}>Scan with any UPI app</div>
            <div style={{ fontSize: 13, fontWeight: 700, color: '#9d7fd4' }}>mrinnn06@oksbi</div>
