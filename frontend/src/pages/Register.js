    ...
    <div style={{ minHeight: '100vh', background: 'var(--void)', display: 'flex', position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '40px', overflowY: 'auto', position: 'relative', zIndex: 1 }}>
        <div style={{ width: '100%', maxWidth: 480, paddingBottom: 40, animation: 'slide-up 0.6s ease forwards' }}>
          ...
          {/* Google */}
          <a href="http://https://innoventure-backend.onrender.com/api/auth/google" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 12, padding: '13px', background: 'rgba(255,255,255,0.05)', border: '1.5px solid rgba(255,255,255,0.1)', borderRadius: 14, color: 'white', textDecoration: 'none', fontSize: 14, fontWeight: 700, marginBottom: 24, transition: 'all 0.2s', fontFamily: 'var(--font-body)' }}
